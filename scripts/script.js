...
// Keep last fetched results so sorting re-renders without a new API call
let lastMovies = [];
let lastQuery = "";
...
// Re-render with new sort order without hitting the API again
sortFilter.addEventListener("change", () => {
  if (lastMovies.length > 0) renderMovies(lastMovies, lastQuery);
});
